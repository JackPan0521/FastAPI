...
{{ 
  ...
  "行程": [
    {{
      ...
      "日期": 21,
      "持續時間": 30,  # 單位：分鐘
      "多元智慧領域": "<只能選以下之一：fatigue_bodily_kinesthetic、fatigue_interpersonal、fatigue_intrapersonal、fatigue_linguistic、fatigue_logical、fatigue_musical、fatigue_naturalistic、fatigue_spatial 輸出時要包含前綴 fatigue_>"
    }}
  ]
}}
